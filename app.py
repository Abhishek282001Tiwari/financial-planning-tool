...
# Ultra-clean, Claude-style minimalist CSS
st.markdown("""
<style>
    /* Import Inter font - Claude's choice */
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap');
    
    /* Claude-exact color palette */
    :root {
        --bg-primary: #FFFFFF;
        --bg-accent: #ECEEF3;
        --bg-sidebar: #F9FAFB;
    ...
    * {
    ...
    /* Claude-style typography hierarchy */
    .hero-title {
        font-size: 3rem;
        font-weight: 600;
        color: var(--text-primary);
    ...
    /* Chart styling to match Claude aesthetic */
    .plotly-graph-div {
        border-radius: 15px;
        overflow: hidden;
    }
...
# Constants with soft, Claude-style color palette
ASSET_CLASSES = {
...
if calculate_button or st.session_state.calculated:
    ...
    with col1:
        ...
        # Create soft, Claude-style pie chart
        if total_invested > 0:
    ...
    # Create soft, Claude-style grouped bar chart
